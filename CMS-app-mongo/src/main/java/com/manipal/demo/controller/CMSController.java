...
public class CMSController {
	...
	@GetMapping("/countries/lang/{language}")
	public List<CMS> retriveCountriesByLanguage(@PathVariable String language) {
		return cmsService.getAllCountryByLanguage(language);
	}
	
	@GetMapping("/countries/name/{countryName}")
	public CMS retriveDetailsByCountryName(@PathVariable String countryName) {
		
		
				return  cmsService.getCountryDetailsByName(countryName);
			
	}
	
	@GetMapping("/countries/population/{population}")
	public List<CMS> retriveCountriesByPopulation(@PathVariable int population) {
		return cmsService.getAllCountryByPopulation(population);
	}
